...
require (
	...
	// Includes the UDP DNS routing fix (tailscale/tailscale#20786) and
	// v1.102.3's security fixes. Keep this pin until a stable release includes both.
	tailscale.com v1.103.0-pre.0.20260819151608-90ed0bcf4bc2
)
